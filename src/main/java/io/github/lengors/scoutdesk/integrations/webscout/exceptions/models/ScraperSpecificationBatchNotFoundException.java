 ...
 * <p>
 * Returns a 404 NOT FOUND HTTP status with a message listing the missing specification names.
 *
 * @author lengors
 */
public final class ScraperSpecificationBatchNotFoundException extends ResponseStatusException {
  ...
  public ScraperSpecificationBatchNotFoundException(final Collection<String> names) {
    super(HttpStatus.NOT_FOUND, "Specifications missing: %s".formatted(String.join(", ", names)));
  }
}
