 ...
 * @author lengors
 */
public record ScraperOwnedSpecificationBatchByReferrerAndStatusFilter(
   ...
   * @param referrer The referrer of the specifications to filter by
   */
  public ScraperOwnedSpecificationBatchByReferrerAndStatusFilter(final ScraperOwnedSpecificationReferrer referrer) {
