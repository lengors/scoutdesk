 ...
 * {@link io.github.lengors.scoutdesk.domain.scrapers.profiles.models.ScraperOwnedProfileEntity} class by instantiating
 * it with a {@link ScraperOwnedSpecificationReference} and a {@link ScraperOwnedProfileReference}.
 *
 * @param specificationReference the {@link ScraperOwnedSpecificationReference} to be used in the test
 * @param profileReference       the {@link ScraperOwnedProfileReference} to be used in the test
...
public record ScraperOwnedProfileTestingEntity(
  ...
  /**
   * This constructor is used to create a new instance of the class with the specified owner, name, and inputs.
   *
   ...
   * {@link ScraperOwnedSpecificationReference} and a null status.
   *
   * @param specificationReference the {@link ScraperOwnedSpecificationReference} to be used in the test
   * @param profileReference       the {@link ScraperOwnedProfileReference} to be used in the test
   */
  ...
  /**
   * This constructor is used to create a new instance of the class with the specified owner and name, setting the
   * status to null.
   *
   * @param specificationOwner the owner of the specification
   * @param specificationName  the name of the specification
