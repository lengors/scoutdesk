 ...
 * {@link io.github.lengors.scoutdesk.domain.scrapers.specifications.models.ScraperOwnedSpecificationEntity} class by
 * instantiating it with a {@link ScraperOwnedSpecificationReference} and a {@link ScraperOwnedSpecificationStatus}.
 *
 * @param reference the {@link ScraperOwnedSpecificationReference} to be used in the test
 * @param status    the {@link ScraperOwnedSpecificationStatus} to be used in the test
 * @author lengors
 */
public record ScraperOwnedSpecificationTestingEntity(
  ...
  /**
   * This constructor is used to create a new instance of the class with the specified owner, name, and status.
   *
